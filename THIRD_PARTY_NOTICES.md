...
External font files are never bundled by default. Anyone adding or distributing one must preserve its required copyright and license notice. The same rule applies to datasets and locally trained Model Bundles.
