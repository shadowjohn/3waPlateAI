"""Local CPU-only detector training entry point."""
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="plateai-detect-train", description="Train the native multi-plate pose detector locally on CPU.")
